...
window.Callin = (function () {
  ...
  const ASKS = [
    ...
    // --- go live ---
    { group: 'show', need: 'allow_on_air', say: 'Flip “Live on air” before you call.',
      why: 'The phone-in: your conversation with the DJ goes out on the station while it happens, a few seconds behind. Chosen before the call with the toggle, never sprung on you mid-call.' },
  ];
