...
window.Callin = (function () {
  ...
  const ASKS = [
    ...
    { group: 'request', need: 'allow_album_queue', say: '“Have you got Rumours? Play the whole thing.”',
      why: 'Queues the full album in one go — every track the library holds of it.' },
    { group: 'request', need: 'allow_album_queue', say: '“Queue up a mix of 90s rock.”',
      why: 'The DJ picks a handful from the real shelves and lines them all up at once.' },
