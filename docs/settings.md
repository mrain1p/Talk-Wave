...
| The call card | **Embed on another page** | The copyable snippet with a **Shape** picker — the inline card, or a floating launcher pill that opens the card support-chat style — plus starting look and captions, and a compact preview |
