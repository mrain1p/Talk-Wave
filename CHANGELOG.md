...
- **Dependabot goes quiet.** Its first firing buried the operator in ten version-bump PRs against deliberately pinned versions; it now watches for security updates only.
